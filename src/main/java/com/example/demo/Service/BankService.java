...
public class BankService {
    ...
    public String transferMoney(int senderId,String receiverUsername,double amount){
        ...
        if(senderAccount == null) return "Sender account not found";
        ...
        if(receiverUser == null) return "Receiver not found";
    ...
    public String qrPayment(int senderId,int receiverId,double amount){
        ...
        if(senderAccount == null || receiverAccount == null) return "Account not found";
        if(senderAccount.getBalance() < amount) return "Insufficient Balance";
